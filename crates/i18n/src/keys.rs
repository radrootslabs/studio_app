...
define_app_text_keys! {
    ...
    TradeWorkflowAxisEvidence => "trade.workflow.axis.evidence",
    TradeWorkflowAxisConflict => "trade.workflow.axis.conflict",
    TradeWorkflowAxisPrivateTerms => "trade.workflow.axis.private_terms",
    TradeWorkflowAxisAttestation => "trade.workflow.axis.attestation",
    ...
    TradeWorkflowAgreementContested => "trade.workflow.agreement.contested",
    ...
    TradeWorkflowEvidenceComplete => "trade.workflow.evidence.complete",
    TradeWorkflowEvidenceMissing => "trade.workflow.evidence.missing",
    TradeWorkflowEvidenceQueryPartial => "trade.workflow.evidence.query_partial",
    TradeWorkflowEvidenceUnsupportedVersion => "trade.workflow.evidence.unsupported_version",
    TradeWorkflowConflictNone => "trade.workflow.conflict.none",
    TradeWorkflowConflictConcurrentCandidates => "trade.workflow.conflict.concurrent_candidates",
    TradeWorkflowConflictDoubleAcceptance => "trade.workflow.conflict.double_acceptance",
    TradeWorkflowConflictDecisionConflict => "trade.workflow.conflict.decision_conflict",
    TradeWorkflowConflictCancellationConflict => "trade.workflow.conflict.cancellation_conflict",
    TradeWorkflowConflictInvalidCausalChain => "trade.workflow.conflict.invalid_causal_chain",
    TradeWorkflowConflictInventoryAuthorityConflict => "trade.workflow.conflict.inventory_authority_conflict",
    TradeWorkflowPrivateTermsNotRequired => "trade.workflow.private_terms.not_required",
    TradeWorkflowPrivateTermsAvailableVerified => "trade.workflow.private_terms.available_verified",
    TradeWorkflowPrivateTermsMissing => "trade.workflow.private_terms.missing",
    TradeWorkflowPrivateTermsUndecryptable => "trade.workflow.private_terms.undecryptable",
    TradeWorkflowPrivateTermsCommitmentMismatch => "trade.workflow.private_terms.commitment_mismatch",
    TradeWorkflowAttestationNone => "trade.workflow.attestation.none",
    TradeWorkflowAttestationPresentValid => "trade.workflow.attestation.present_valid",
    TradeWorkflowAttestationPresentInvalid => "trade.workflow.attestation.present_invalid",
    TradeWorkflowAttestationConflicting => "trade.workflow.attestation.conflicting",
    ...
    MetadataSdkRuntimePath => "metadata.sdk_runtime_path",
    MetadataSdkPrivatePath => "metadata.sdk_private_path",
    MetadataSdkStudioPath => "metadata.sdk_studio_path",
