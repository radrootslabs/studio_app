...
define_app_text_keys! {
    ...
    TradeWorkflowAgreementAgreedPendingValidation => "trade.workflow.agreement.agreed_pending_validation",
    ...
    TradeWorkflowAgreementValidationExpired => "trade.workflow.agreement.validation_expired",
